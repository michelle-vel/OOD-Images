...
/**
 * This class is in charge of converting an image into a green greyscale image.
 */
public class Green implements ICommand {
  ...
  public Green(String oldName, String newName) {
  ...
  public void run(IImage img) {
    img.greenGrayscale(oldName, newName);
  }
}
